...
augroup highlight-cursor-word
	...
	" 単語のハイライト設定
	autocmd ColorScheme * highlight CursorWord ctermfg=DarkMagenta guifg=Red
	" アンダーラインでハイライトを行う場合
	" autocmd ColorScheme * highlight
	"CursorWord gui=underline guifg=NONE
...
" =============================================================
" {{{ コマンドラインウィンドウの履歴を最新20個に保つ

augroup cmdwin
	autocmd!
	" コマンドラインウィンドウの末尾の20行を除いて全て削除する
	autocmd CmdwinEnter * :silent! 1,$-20 delete _ | call cursor("$", 1)
augroup END
